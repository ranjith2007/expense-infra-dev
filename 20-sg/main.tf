module "mysql_sg" {
  source       = "git::https://github.com/ranjith2007/terraform-aws-security-group.git?ref=main"
...
# frontend allowing connection on 80 to public (Frontend is connecting to public using Ip 0.0.0.0/0)
